...
df = pd.read_csv(os.path.join('Static', 'staticDataScripts', 'staticData', 'players.csv'))
...
df.reset_index(drop=True).to_csv(os.path.join('Static', 'staticDataScripts', 'staticData', 'filteredPlayers.csv'))
